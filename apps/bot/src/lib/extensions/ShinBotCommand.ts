...
export abstract class ShinBotCommand<M extends Module> extends ModuleCommand<M> {
	public helpEmbed: EmbedBuilder;

	public constructor(context: ShinBotCommand.Context, options: ShinBotCommand.Options) {
...
export namespace ShinBotCommand {
